...
import { H3Event, toResponse, useSession as useSession$1 } from "h3-v2";
...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-QVa75uf0.js");
...
const manifest = { "4dd14be03b6a3bc889697fce696b6760308355fb014129c843bc0126b915798a": {
  functionName: "fetchUser_createServerFn_handler",
  importer: () => import("./assets/user-CMfU8JwM.js")
}, "66e4aa56b5ca900a69c32e51241283820c0b97e11da5c2bd58401096921d465b": {
  functionName: "getOrders_createServerFn_handler",
  importer: () => import("./assets/get-orders-CbC_Wqon.js")
}, "940ecf381cf00c6ec826d513d4b1f59c2acebeaaa13d44039385992f416cdabe": {
  functionName: "getPatients_createServerFn_handler",
  importer: () => import("./assets/get-patients-B0rbr58H.js")
}, "c88486d987bc781979795812a800e00a629ba1bda12b61cd59fb5fad1b1c1b16": {
  functionName: "getOrder_createServerFn_handler",
  importer: () => import("./assets/get-order-BOuGdLPF.js")
}, "04bb5248c9b0d87d1a94364c317de5f8a2b77fabff80364eb6cf167f1032d41c": {
  functionName: "getPatient_createServerFn_handler",
  importer: () => import("./assets/get-patient-ABpKjTCU.js")
}, "f5bd48d1524c4f31fe78ff373daf8dada5107a3ac1afe0c8c75f9efa3e2dee99": {
  functionName: "logoutFn_createServerFn_handler",
  importer: () => import("./assets/logout-B1sbfP-T.js")
}, "ef99fa68986f704a3b4faad8aa951c748224e97076d74f49ac79a6870214a0ef": {
  functionName: "createPatient_createServerFn_handler",
  importer: () => import("./assets/create-patient-cflAQ6-0.js")
}, "2ef30eddd7c47d0d46d82843c1ce6b06a43ca54037008a0dc3fc159705fc12a8": {
  functionName: "loginFn_createServerFn_handler",
  importer: () => import("./assets/login-BrSakMZ0.js")
}, "9fb36a3bc07db7f995bfaf430ef6864612da15a3b35e379d7deb968238d76812": {
  functionName: "deletePatient_createServerFn_handler",
  importer: () => import("./assets/delete-patient-B0OwLcUR.js")
}, "297629842e2d65fb3b4d80b076ff308dd6d22bdba756791f6f74ccb618c756c6": {
  functionName: "signupFn_createServerFn_handler",
  importer: () => import("./assets/signup-B2JTbu6d.js")
}, "b92d5239e21e866e19602ce1d1cdfe2b2dbad6d15ac052893a67171db78fb906": {
  functionName: "updatePatient_createServerFn_handler",
  importer: () => import("./assets/update-patient-DBOdRTyV.js")
}, "86f303f442bd6a6cd2200a3b53b5498707cf3134f40c6dc657d3f51d7acd4433": {
  functionName: "deleteOrder_createServerFn_handler",
  importer: () => import("./assets/delete-order-Gsz9EFtN.js")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-CUTPFSxq.js").then((n) => n.r);
    }
    if (startEntry === null) {
